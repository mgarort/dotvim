...
" My Vimwiki highlights

call s:hi('VimwikiBold', s:palette.gray10, [], 'bold')
call s:hi('VimwikiItalic', s:palette.gray10, [], 'italic')
call s:hi('VimwikiDelText', s:palette.gray10, [], 'underline')
